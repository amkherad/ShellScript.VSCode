...
import * as codeCompletion from './completion';
...
export function activate(context: ExtensionContext) {
	...
	let serverModule = context.asAbsolutePath('server/out/');
	...
	let lc = new LanguageClient('shellscriptLanguageServer', 'ShellScript Language Server', serverOptions, clientOptions);
	...
	codeCompletion.enableCodeCompletion(context);
}
